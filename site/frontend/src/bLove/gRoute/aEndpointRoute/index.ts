const endpointRoute = {
  aGlobalRoute: {
    aUnprotectedRoute: {
      aHomePageRoute: "",
      bAboutCompanyPageRoute: "about-company-page",
      cAboutApplicationPageRoute: "about-application-page",
      dContactPageRoute: "contact-page",
      eServicePageRoute: "service-page",
      fBranchSectionPageRoute: "branch-section-page",
      gBranchGroupPageRoute: "branch-group-page",
      hBranchPageRoute: "branch-page",
      iProjectSectionPageRoute: "project-section-page",
      jProjectGroupPageRoute: "project-group-page",
      kProjectPageRoute: "project-page",
    },
    bProtectedRoute: {
      aAutheticatedRoute: {
