    ...
    try {
      const serverResponse = await updateAPITrigger({ 
        body: {
          ...
          dAddress: {
            aLane: data.dAddress?.aLane,
            bStreet: data.dAddress?.bStreet,
            cCity: data.dAddress?.cCity,
            dState: data.dAddress?.dState,
            eCountry: data.dAddress?.eCountry,
            fPinCode: data.dAddress?.fPinCode,
          },
          dLinks: data?.dLinks,
