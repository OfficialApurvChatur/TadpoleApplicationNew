...
import AdminBranchGroupCreateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/iAdminBranchGroupComponent/bCreateComponent";
...
const AdminBranchGroupCreatePage = () => {
  // Variable
  const navigate = useNavigate();
  const [ createAPITrigger, createAPIResponse ] = adminBranchGroupAPIEndpoint.useAdminBranchGroupCreateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminBranchGroup, "Create") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AdminBranchGroupCreatePage */}
...
export default AdminBranchGroupCreatePage;
