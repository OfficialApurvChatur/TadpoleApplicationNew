...
import AccountCreateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/bUserAdministrationComponent/gAccountComponent/bCreateComponent";
...
const AccountCreatePage = () => {
  ...
  const [ createAPITrigger, createAPIResponse ] = accountAPIEndpoint.useAccountCreateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.account, "Create") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AccountCreatePage */}
