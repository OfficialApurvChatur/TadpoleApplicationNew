...
import ContactInfoCreateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/eContactInfoComponent/bCreateComponent";
...
const ContactInfoCreatePage = () => {
  // Variable
  const navigate = useNavigate();
  const [ createAPITrigger, createAPIResponse ] = contactInfoAPIEndpoint.useContactInfoCreateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.contactInfo, "Create") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* ContactInfoCreatePage */}
...
export default ContactInfoCreatePage;
