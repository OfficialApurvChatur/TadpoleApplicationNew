...
import RequestCreateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/hChatManagement/cRequestComponent/bCreateComponent";
...
const RequestCreatePage = () => {
  ...
  const [ createAPITrigger, createAPIResponse ] = requestAPIEndpoint.useRequestCreateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.request, "Create") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* RequestCreatePage */}
