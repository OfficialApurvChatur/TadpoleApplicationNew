      ...
      // Relation Information
      {
        ...
        inputs: [
          { name: "cBranches", label: "Branches", type: "checkbox", 
            options: 
              apiCall.branchListAPIResponse.isLoading ? null : 
              apiCall.branchListAPIResponse.isError ? null :
                apiCall.branchListAPIResponse.isSuccess ? (
                  apiCall.branchListAPIResponse.data.success ? (
                    apiCall.branchListAPIResponse.data.list.length > 0 ? (
                      apiCall.branchListAPIResponse.data.list.map((each: any) => ({
