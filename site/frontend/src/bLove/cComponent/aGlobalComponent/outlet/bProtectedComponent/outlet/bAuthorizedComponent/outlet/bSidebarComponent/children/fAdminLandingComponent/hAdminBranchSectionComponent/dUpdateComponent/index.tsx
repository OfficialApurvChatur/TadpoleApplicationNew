...
type AdminBranchSectionUpdateComponentType = {
  formHeader: any,
  formData: any,
  formValueSchema: any,
...
const AdminBranchSectionUpdateComponent = (props: AdminBranchSectionUpdateComponentType) => {
  // JSX
  return (
    <React.Fragment>
...
export default AdminBranchSectionUpdateComponent;
