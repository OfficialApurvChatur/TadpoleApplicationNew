...
type AdminBranchSectionCreateComponentType = {
  formHeader: any,
  formData: any,
  formValueSchema: any,
...
const AdminBranchSectionCreateComponent = (props: AdminBranchSectionCreateComponentType) => {
  // JSX
  return (
    <React.Fragment>
...
export default AdminBranchSectionCreateComponent;
