...
type SocialMediaContentUpdateComponentType = {
  formHeader: any,
  formData: any,
  formValueSchema: any,
...
const SocialMediaContentUpdateComponent = (props: SocialMediaContentUpdateComponentType) => {
  // JSX
  return (
    <React.Fragment>
...
export default SocialMediaContentUpdateComponent;
