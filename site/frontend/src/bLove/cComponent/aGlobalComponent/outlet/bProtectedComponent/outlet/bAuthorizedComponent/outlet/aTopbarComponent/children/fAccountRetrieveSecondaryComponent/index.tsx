...
const AccountRetrieveSecondaryComponent = (props: AccountRetrieveSecondaryComponentType) => {
                ...
                <div>
                  ...
                  <div className="-mt-28 mb-14 px-4">
                    <div className="mx-auto max-w-6xl shadow-lg md:p-8 relative bg-muted rounded-sm">
                      {/* Banner Content */}
                      <h2 className="text-xl text-foreground font-semibold py-6 text-center uppercase">View Profile Section</h2>
...
export default AccountRetrieveSecondaryComponent;
