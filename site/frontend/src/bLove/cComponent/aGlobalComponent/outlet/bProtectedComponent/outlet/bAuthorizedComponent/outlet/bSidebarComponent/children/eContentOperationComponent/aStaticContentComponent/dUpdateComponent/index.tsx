...
type StaticContentUpdateComponentType = {
  formHeader: any,
  formData: any,
  formValueSchema: any,
...
const StaticContentUpdateComponent = (props: StaticContentUpdateComponentType) => {
  // JSX
  return (
    <React.Fragment>
...
export default StaticContentUpdateComponent;
