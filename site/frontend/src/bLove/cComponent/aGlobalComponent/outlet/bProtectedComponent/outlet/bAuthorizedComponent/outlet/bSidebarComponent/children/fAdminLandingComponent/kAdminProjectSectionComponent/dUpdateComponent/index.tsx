...
type AdminProjectSectionUpdateComponentType = {
  formHeader: any,
  formData: any,
  formValueSchema: any,
...
const AdminProjectSectionUpdateComponent = (props: AdminProjectSectionUpdateComponentType) => {
  // JSX
  return (
    <React.Fragment>
...
export default AdminProjectSectionUpdateComponent;
