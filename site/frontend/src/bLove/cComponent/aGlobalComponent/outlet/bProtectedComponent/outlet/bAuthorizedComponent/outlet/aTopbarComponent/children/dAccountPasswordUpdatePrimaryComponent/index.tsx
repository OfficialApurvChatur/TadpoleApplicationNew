...
type AccountPasswordUpdatePrimaryComponentType = {
  formSchema: any,
...
const AccountPasswordUpdatePrimaryComponent = (props: AccountPasswordUpdatePrimaryComponentType) => {
  // Variable
  ...
  return (
    <React.Fragment>
      {/* AccountPasswordUpdatePrimaryComponent */}
...
export default AccountPasswordUpdatePrimaryComponent;
