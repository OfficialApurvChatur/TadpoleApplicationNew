...
import { BookmarkX, FolderKey, KeyRound, LogIn, LogOut, MailIcon, Rat, ShieldCheckIcon, User2, UserPen, UserPlus } from "lucide-react";
        ...
        <div className="flex flex-wrap items-center justify-between gap-5 w-full">
          ...
          <a href={brandConnection.rFrontendBaseURL[0]} className="flex items-center gap-3 shrink-0">
            ...
            <div className="hidden md:flex flex-col leading-none">
              <span className="text-lg font-bold uppercase leading-tight -mb-1">
            ...
            >
              ...
              {/* Items */}
              {
                ...
                props.reduxCall.state.receivedObject?.AccountRetrieve?._id && (
                  <li className="max-lg:border-b max-lg:border-muted-foreground max-lg:py-3 px-3">
                    <Link 
                      to={`${brandConnection.gAdminApplicationURL}`}
              ...
              <li className="max-lg:border-b max-lg:border-muted-foreground max-lg:py-3 px-3">
                <Link 
                  ...
                  className={`
                    ...
                    ${pathname === fullRoute.aGlobalRoute.aUnprotectedRoute.aHomePageRoute ? "text-foreground" : "text-muted-foreground"}
                  `}
                >
                  Home
                </Link>
              ...
              <li className="max-lg:border-b max-lg:border-muted-foreground group max-lg:px-3 max-lg:py-3 relative">
                <span 
                  className={`
                    ...
                    ${(
                      pathname === fullRoute.aGlobalRoute.aUnprotectedRoute.bAboutCompanyPageRoute ||
                      pathname === fullRoute.aGlobalRoute.aUnprotectedRoute.cAboutApplicationPageRoute
                ...
                <div className="absolute lg:top-8 max-lg:top-10 z-50 flex shadow-lg bg-muted-foreground max-h-0 overflow-hidden group-hover:opacity-100 group-hover:max-h-[700px] px-8 group-hover:pb-8 group-hover:pt-6 transition-all duration-500">
                  <div className="lg:min-w-[180px] max-lg:min-w-[140px]">
                    ...
                    <ul className="mt-3 pt-3 border-t border-background space-y-3">
                      <li className="py-1">
                        <Link 
                          ...
                          className={`
                            ...
                            ${pathname === fullRoute.aGlobalRoute.aUnprotectedRoute.bAboutCompanyPageRoute ? "text-background font-bold" : "text-muted font-normal"}
                          `} 
                        >
                          About Company
                        </Link>
                      ...
                      <li className="py-1">
                        <Link 
                          to={fullRoute.aGlobalRoute.aUnprotectedRoute.cAboutApplicationPageRoute} 
                          className={`
                            hover:font-medium hover:text-background text-[15px] block
                            ${pathname === fullRoute.aGlobalRoute.aUnprotectedRoute.cAboutApplicationPageRoute ? "text-background font-bold" : "text-muted font-normal"}
                          `} 
                        >
                          About Application
                        </Link>
              ...
              <li className="max-lg:border-b max-lg:border-muted-foreground max-lg:py-3 px-3">
                <Link 
                  ...
                  className={`
                    hover:text-foreground block font-medium text-[15px]
                    ${pathname === fullRoute.aGlobalRoute.aUnprotectedRoute.eServicePageRoute ? "text-foreground" : "text-muted-foreground"}
                  `}
                >
                  Service
                </Link>
              ...
              <li className="max-lg:border-b max-lg:border-muted-foreground max-lg:py-3 px-3">
                <Link 
                  ...
                  className={`
                    hover:text-foreground block font-medium text-[15px]
                    ${pathname === fullRoute.aGlobalRoute.aUnprotectedRoute.fBranchSectionPageRoute ? "text-foreground" : "text-muted-foreground"}
                  `}
                >
                  Branch
                </Link>
              ...
              <li className="max-lg:border-b max-lg:border-muted-foreground max-lg:py-3 px-3">
                <Link 
                  to={fullRoute.aGlobalRoute.aUnprotectedRoute.iProjectSectionPageRoute}
                  className={`
                    hover:text-foreground block font-medium text-[15px]
                    ${pathname === fullRoute.aGlobalRoute.aUnprotectedRoute.iProjectSectionPageRoute ? "text-foreground" : "text-muted-foreground"}
                  `}
                >
                  Project
                </Link>
              ...
              <li className="max-lg:border-b max-lg:border-muted-foreground max-lg:py-3 px-3">
                <Link 
                  ...
                  className={`
                    hover:text-foreground block font-medium text-[15px]
                    ${pathname === fullRoute.aGlobalRoute.aUnprotectedRoute.dContactPageRoute ? "text-foreground" : "text-muted-foreground"}
                  `}
                >
                  Contact
                </Link>
          ...
          <div className="flex max-lg:ml-auto space-x-2">
            ...
            <Button asChild size="icon" variant="outline" >
              <Link to={brandConnection.gAdminApplicationURL} target="_blank" rel="noopener noreferrer" >
                <ShieldCheckIcon />
              </Link>
            </Button>
