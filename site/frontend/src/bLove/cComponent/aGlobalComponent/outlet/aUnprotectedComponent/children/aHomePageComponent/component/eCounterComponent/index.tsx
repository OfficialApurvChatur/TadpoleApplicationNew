    ...
    <React.Fragment>
      ...
      <section id="counter" >
        <div className="bg-gradient-to-tl from-muted/100 via-muted/50 to-muted/0 p-6 sm:p-8">
          ...
          <div className="p-4">
            <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-x-6 gap-y-12 lg:divide-x lg:divide-foreground">
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="fill-foreground w-10 inline-block" viewBox="0 0 512 512">
                ...
                <h3 className="text-3xl font-bold text-foreground mt-6">400+</h3>
                <h6 className="text-base text-muted-foreground font-medium mt-2">Unique Visitors</h6>
              </div>
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="fill-foreground w-10 inline-block" viewBox="0 0 512 512">
                ...
                <h3 className="text-3xl font-bold text-foreground mt-6">450+</h3>
                <h6 className="text-base text-muted-foreground font-medium mt-2">Total Sales</h6>
              </div>
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="fill-foreground w-10 inline-block" viewBox="0 0 28 28">
                ...
                <h3 className="text-3xl font-bold text-foreground mt-6">500+</h3>
                <h6 className="text-base text-muted-foreground font-medium mt-2">Customer Satisfaction</h6>
              </div>
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="fill-foreground w-10 inline-block" viewBox="0 0 512 512">
                ...
                <h3 className="text-3xl font-bold text-foreground mt-6">600+</h3>
                <h6 className="text-base text-muted-foreground font-medium mt-2">System Uptime (in hours)</h6>
              </div>
            </div>
          </div>
        </div>
