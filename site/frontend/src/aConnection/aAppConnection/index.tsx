...
const AboutCompanyPagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/bAboutCompanyPagePage"));
const AboutApplicationPagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/cAboutApplicationPagePage"));
const ContactPagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/dContactPagePage"));
const ServicePagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/eServicePagePage"));
const BranchSectionPagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/fBranchSectionPagePage"));
const BranchGroupPagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/gBranchGroupPagePage"));
const BranchPagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/hBranchPagePage"));
const ProjectSectionPagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/iProjectSectionPagePage"));
const ProjectGroupPagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/jProjectGroupPagePage"));
const ProjectPagePage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/aUnprotectedPage/page/kProjectPagePage"));
...
const AccountRetrieveSecondaryPage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/bProtectedPage/outlet/bAuthorizedPage/outlet/aTopbarPage/page/fAccountRetrieveSecondaryPage"));
const AccountUpdateSecondaryPage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/bProtectedPage/outlet/bAuthorizedPage/outlet/aTopbarPage/page/gAccountUpdateSecondaryPage"));
const AccountEmailUpdateSecondaryPage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/bProtectedPage/outlet/bAuthorizedPage/outlet/aTopbarPage/page/hAccountEmailUpdateSecondaryPage"));
const AccountPasswordUpdateSecondaryPage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/bProtectedPage/outlet/bAuthorizedPage/outlet/aTopbarPage/page/iAccountPasswordUpdateSecondaryPage"));
const AccountDeleteSecondaryPage = React.lazy(() => import("@/bLove/fPage/aGlobalPage/outlet/bProtectedPage/outlet/bAuthorizedPage/outlet/aTopbarPage/page/jAccountDeleteSecondaryPage"));
      ...
      <Routes>
        <Route element={<GlobalLayout />} >
          <Route element={<UnprotectedLayout />} >
            ...
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.bAboutCompanyPageRoute}`} element={<AboutCompanyPagePage />} />
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.cAboutApplicationPageRoute}`} element={<AboutApplicationPagePage />} />
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.dContactPageRoute}`} element={<ContactPagePage />} />
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.eServicePageRoute}`} element={<ServicePagePage />} />
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.fBranchSectionPageRoute}`} element={<BranchSectionPagePage />} />
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.gBranchGroupPageRoute}`} element={<BranchGroupPagePage />} />
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.hBranchPageRoute}`} element={<BranchPagePage />} />
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.iProjectSectionPageRoute}`} element={<ProjectSectionPagePage />} />
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.jProjectGroupPageRoute}`} element={<ProjectGroupPagePage />} />
            <Route path={`${endpointRoute.aGlobalRoute.aUnprotectedRoute.kProjectPageRoute}`} element={<ProjectPagePage />} />
          </Route>
          <Route element={<ProtectedLayout />} >
            <Route element={<AuthenticatedLayout />} >
              ...
              <Route path={`${endpointRoute.aGlobalRoute.bProtectedRoute.aAutheticatedRoute.dResetPasswordRoute}/:token`} element={<ResetPasswordPage />} />
            </Route>
            <Route element={<AuthorizedLayout />} >
              <Route element={<TopbarLayout />} >
                ...
                <Route path={`${endpointRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.aTopbarRoute.fAccountRetrieveSecondaryRoute}`} element={<AccountRetrieveSecondaryPage />} />
                <Route path={`${endpointRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.aTopbarRoute.gAccountUpdateSecondaryRoute}`} element={<AccountUpdateSecondaryPage />} />
                <Route path={`${endpointRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.aTopbarRoute.hAccountEmailUpdateSecondaryRoute}`} element={<AccountEmailUpdateSecondaryPage />} />
                <Route path={`${endpointRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.aTopbarRoute.iAccountPasswordUpdateSecondaryRoute}`} element={<AccountPasswordUpdateSecondaryPage />} />
                <Route path={`${endpointRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.aTopbarRoute.jAccountDeleteSecondaryRoute}`} element={<AccountDeleteSecondaryPage />} />
              </Route>
