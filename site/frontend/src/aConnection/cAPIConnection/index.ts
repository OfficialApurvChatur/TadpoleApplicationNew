...
const apiConnection = createApi({
  ...
  tagTypes: [
    "homePageRetrieve"               , 
    "aboutCompanyPageRetrieve"       , 
    "aboutApplicationPageRetrieve"   , 
    "contactPageRetrieve"            , 
    "servicePageRetrieve"            , 
    "branchSectionPageRetrieve"      , 
    "branchGroupPageRetrieve"        , 
    "branchPageRetrieve"             , 
    "projectSectionPageRetrieve"     , 
    "projectGroupPageRetrieve"       , 
    "projectPageRetrieve"            , 
