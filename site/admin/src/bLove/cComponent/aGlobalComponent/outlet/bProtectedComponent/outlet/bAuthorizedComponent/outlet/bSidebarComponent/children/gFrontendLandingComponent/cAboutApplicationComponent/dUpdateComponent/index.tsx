...
type AboutApplicationUpdateComponentType = {
  formHeader: any,
  formData: any,
  formValueSchema: any,
...
const AboutApplicationUpdateComponent = (props: AboutApplicationUpdateComponentType) => {
  // JSX
  return (
    <React.Fragment>
...
export default AboutApplicationUpdateComponent;
