...
type ProjectSectionUpdateComponentType = {
  formHeader: any,
  formData: any,
  formValueSchema: any,
...
const ProjectSectionUpdateComponent = (props: ProjectSectionUpdateComponentType) => {
  // JSX
  return (
    <React.Fragment>
...
export default ProjectSectionUpdateComponent;
