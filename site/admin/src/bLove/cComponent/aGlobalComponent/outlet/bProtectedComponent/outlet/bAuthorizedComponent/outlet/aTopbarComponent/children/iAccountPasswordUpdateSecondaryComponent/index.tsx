...
type AccountPasswordUpdateSecondaryComponentType = {
  formSchema: any,
...
const AccountPasswordUpdateSecondaryComponent = (props: AccountPasswordUpdateSecondaryComponentType) => {
  // Variable
                ...
                <div>
                  ...
                  <div className="-mt-28 mb-14 px-4">
                    <div className="mx-auto max-w-6xl shadow-lg md:p-8 relative bg-muted rounded-sm">
                      {/* Banner Content */}
                      <h2 className="text-xl text-foreground font-semibold py-6 text-center uppercase">Password Update Section</h2>
                      ...
                      <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} noValidate className="mt-8 grid gap-6">
                          ...
                          <div className="mx-2 p-4 rounded-md border flex flex-col gap-6 col-span-full">
                            ...
                            >
                              {props.apiCall.updateAPIResponse.isLoading ? "Loading..." : "Update Password"}
                            </Button>
                          </div>
...
export default AccountPasswordUpdateSecondaryComponent;
