...
type BranchSectionUpdateComponentType = {
  formHeader: any,
  formData: any,
  formValueSchema: any,
...
const BranchSectionUpdateComponent = (props: BranchSectionUpdateComponentType) => {
  // JSX
  return (
    <React.Fragment>
...
export default BranchSectionUpdateComponent;
