...
type AdminContactInfoUpdateComponentType = {
  formHeader: any,
  formData: any,
  formValueSchema: any,
...
const AdminContactInfoUpdateComponent = (props: AdminContactInfoUpdateComponentType) => {
  // JSX
  return (
    <React.Fragment>
...
export default AdminContactInfoUpdateComponent;
