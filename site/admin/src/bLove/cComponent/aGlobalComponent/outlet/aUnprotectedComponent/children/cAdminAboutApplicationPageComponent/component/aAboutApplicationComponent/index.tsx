...
interface AboutApplicationComponentProps {
  reduxCall: any;
  apiResponse: AboutApplicationComponentDataType;
}

export const AboutApplicationComponent = (props: AboutApplicationComponentProps) => {
  // Destructure Props
  ...
  const [selectedTab, setSelectedTab] = useState<TabKey>(adminApplication);
