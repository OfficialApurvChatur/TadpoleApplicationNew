        ...
        <div className="bg-gradient-to-tl from-muted/100 via-muted/50 to-muted/0 p-6 sm:p-8">
          ...
          <div className="p-4">
            ...
            <div id="settingContent" className="tab-content w-11/13 hidden mt-8">
              <h4 className="text-base font-semibold text-muted-foreground">Settings</h4>
            ...
            <div id="profileContent" className="tab-content w-11/13 hidden mt-8">
              <h4 className="text-base font-semibold text-muted-foreground">Users</h4>
              <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
            ...
            <div id="inboxContent" className="tab-content w-11/13 hidden mt-8">
              <h4 className="text-base font-semibold text-muted-foreground">Inbox</h4>
              <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
            ...
            <div id="notificationContent" className="tab-content w-11/13 hidden mt-8">
              <h4 className="text-base font-semibold text-muted-foreground">Notifications</h4>
              <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
