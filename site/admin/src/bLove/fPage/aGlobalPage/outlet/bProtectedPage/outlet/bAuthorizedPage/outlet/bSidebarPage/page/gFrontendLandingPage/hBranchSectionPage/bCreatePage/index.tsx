...
import BranchSectionCreateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/hBranchSectionComponent/bCreateComponent";
...
const BranchSectionCreatePage = () => {
  // Variable
  const navigate = useNavigate();
  const [ createAPITrigger, createAPIResponse ] = branchSectionAPIEndpoint.useBranchSectionCreateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.branchSection, "Create") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* BranchSectionCreatePage */}
...
export default BranchSectionCreatePage;
