      ...
      try {
        const serverResponse = await updateAPITrigger({ 
          ...
          body: {
            ...
            cProjects: submittedData.cProjects,  
          } 
        });
        ...
        if (serverResponse.data && serverResponse.data?.success === true) {
          ...
          return navigate(fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.fAdminLandingRoute.lAdminProjectGroupRoute.aListRoute)
        }
