...
import SignUpCreateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/cUserAuthenticationComponent/bSignUpComponent/bCreateComponent";
...
const SignUpCreatePage = () => {
  ...
  const [ createAPITrigger, createAPIResponse ] = signUpAPIEndpoint.useSignUpCreateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.signUp, "Create") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* SignUpCreatePage */}
