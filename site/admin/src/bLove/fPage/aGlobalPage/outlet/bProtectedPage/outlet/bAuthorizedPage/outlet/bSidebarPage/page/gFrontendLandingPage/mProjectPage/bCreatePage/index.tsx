...
import ProjectCreateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/gFrontendLandingComponent/mProjectComponent/bCreateComponent";
...
const ProjectCreatePage = () => {
  ...
  const [ createAPITrigger, createAPIResponse ] = projectAPIEndpoint.useProjectCreateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.project, "Create") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* ProjectCreatePage */}
