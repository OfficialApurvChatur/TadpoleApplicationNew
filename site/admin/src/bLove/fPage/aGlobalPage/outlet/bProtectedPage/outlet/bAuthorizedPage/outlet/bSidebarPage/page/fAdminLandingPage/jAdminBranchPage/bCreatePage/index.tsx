...
import AdminBranchCreateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/fAdminLandingComponent/jAdminBranchComponent/bCreateComponent";
...
const AdminBranchCreatePage = () => {
  ...
  const [ createAPITrigger, createAPIResponse ] = adminBranchAPIEndpoint.useAdminBranchCreateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.adminBranch, "Create") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* AdminBranchCreatePage */}
