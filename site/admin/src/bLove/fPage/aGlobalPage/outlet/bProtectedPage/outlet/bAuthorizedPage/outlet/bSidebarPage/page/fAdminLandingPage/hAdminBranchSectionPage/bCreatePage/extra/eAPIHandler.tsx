    ...
    (async () => {
      try {
        const serverResponse = await createAPITrigger({ body: {
          ...
          cBranchGroups: submittedData.cBranchGroups
        } });
        ...
        if (serverResponse.data && serverResponse.data?.success === true) {
          ...
          return navigate(fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.fAdminLandingRoute.hAdminBranchSectionRoute.aListRoute)
        }
