  ...
  retrieveAPIResponse.isSuccess ? (
    retrieveAPIResponse.data.success ? ([
      // Basic Information
      {
        ...
        inputs: [
          { name: "aImage", label: "Image", type: "image", folderName: "adminbranchsection" },
      ...
      // Relation Information
      {
        ...
        inputs: [
          { name: "cBranchGroups", label: "Branch Groups", type: "checkbox", 
            options: 
              apiCall.adminBranchGroupListAPIResponse.isLoading ? null : 
              apiCall.adminBranchGroupListAPIResponse.isError ? null :
                apiCall.adminBranchGroupListAPIResponse.isSuccess ? (
                  apiCall.adminBranchGroupListAPIResponse.data.success ? (
                    apiCall.adminBranchGroupListAPIResponse.data.list.length > 0 ? (
                      apiCall.adminBranchGroupListAPIResponse.data.list.map((each: any) => ({
