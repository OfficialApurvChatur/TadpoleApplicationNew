    ...
    (async () => {
      try {
        const serverResponse = await createAPITrigger({ body: {
          ...
          cProjectGroups: submittedData.cProjectGroups
        } });
        ...
        if (serverResponse.data && serverResponse.data?.success === true) {
          ...
          return navigate(fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.fAdminLandingRoute.kAdminProjectSectionRoute.aListRoute)
        }
