      ...
      try {
        const serverResponse = await updateAPITrigger({ 
          ...
          body: {
            ...
            cBranches: submittedData.cBranches,  
          } 
        });
        ...
        if (serverResponse.data && serverResponse.data?.success === true) {
          ...
          return navigate(fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.fAdminLandingRoute.iAdminBranchGroupRoute.aListRoute)
        }
