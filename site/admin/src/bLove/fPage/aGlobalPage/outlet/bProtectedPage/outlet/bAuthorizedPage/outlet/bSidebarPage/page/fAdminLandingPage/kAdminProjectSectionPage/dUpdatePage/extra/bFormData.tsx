  ...
  retrieveAPIResponse.isSuccess ? (
    retrieveAPIResponse.data.success ? ([
      // Basic Information
      {
        ...
        inputs: [
          { name: "aImage", label: "Image", type: "image", folderName: "adminprojectsection" },
      ...
      // Relation Information
      {
        ...
        inputs: [
          { name: "cProjectGroups", label: "Project Groups", type: "checkbox", 
            options: 
              apiCall.adminProjectGroupListAPIResponse.isLoading ? null : 
              apiCall.adminProjectGroupListAPIResponse.isError ? null :
                apiCall.adminProjectGroupListAPIResponse.isSuccess ? (
                  apiCall.adminProjectGroupListAPIResponse.data.success ? (
                    apiCall.adminProjectGroupListAPIResponse.data.list.length > 0 ? (
                      apiCall.adminProjectGroupListAPIResponse.data.list.map((each: any) => ({
