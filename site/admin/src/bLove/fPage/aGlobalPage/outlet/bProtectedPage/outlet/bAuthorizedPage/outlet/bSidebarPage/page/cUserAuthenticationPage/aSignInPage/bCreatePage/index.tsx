...
import SignInCreateComponent from "@/bLove/cComponent/aGlobalComponent/outlet/bProtectedComponent/outlet/bAuthorizedComponent/outlet/bSidebarComponent/children/cUserAuthenticationComponent/aSignInComponent/bCreateComponent";
...
const SignInCreatePage = () => {
  // Variable
  const navigate = useNavigate();
  const [ createAPITrigger, createAPIResponse ] = signInAPIEndpoint.useSignInCreateAPIMutation();
  ...
  // JSX
  return (!isAllowedUtility(reduxCall, isAllowedConstant.signIn, "Create") ? <UnauthorizedAccessComponent /> :
    <React.Fragment>
      {/* SignInCreatePage */}
