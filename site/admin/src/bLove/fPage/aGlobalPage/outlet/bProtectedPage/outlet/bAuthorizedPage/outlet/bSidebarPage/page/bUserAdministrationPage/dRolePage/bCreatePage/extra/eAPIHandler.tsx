    ...
    (async () => {
      try {
        const serverResponse = await createAPITrigger({ body: {
          ...
          cPermission: submittedData.cPermission,
        } });
        ...
        if (serverResponse.data && serverResponse.data?.success === true) {
          ...
          return navigate(fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.bUserAdministrationRoute.dRoleRoute.aListRoute)
        }
