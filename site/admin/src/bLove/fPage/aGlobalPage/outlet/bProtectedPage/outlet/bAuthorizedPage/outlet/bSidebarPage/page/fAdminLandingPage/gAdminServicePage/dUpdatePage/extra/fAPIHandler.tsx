    ...
    (async () => {
      try {
        ...
        if (serverResponse.data && serverResponse.data?.success === true) {
          ...
          return navigate(fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizedRoute.bSidebarRoute.fAdminLandingRoute.gAdminServiceRoute.aListRoute)
        }
