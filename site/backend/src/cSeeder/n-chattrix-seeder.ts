...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/n-chattrix-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Sharanya_Palli.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/14.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Chattrix_Logo.png", "adminhero");
    ...
    const adminHeroSideImage3 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Boilerplate_Logo.png", "adminproject");
    const adminHeroSideImage4 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Andromeda_Logo.png", "adminproject");
    const adminHeroSideImage5 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Anser_Logo.png", "adminproject");
    const adminHeroSideImage6 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/bee.png", "adminproject");
    ...
    const adminHeroSideImage9 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Chattrix_Logo.png", "adminproject");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Chattrix_Logo.png", "hero");
    ...
    const heroSideImage3 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Boilerplate_Logo.png", "project");
    const heroSideImage4 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Andromeda_Logo.png", "project");
    const heroSideImage5 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Anser_Logo.png", "project");
    const heroSideImage6 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/bee.png", "project");
    ...
    const heroSideImage9 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Chattrix_Logo.png", "project");
    ...
    await AdminHeroModel.create({
      ...
      aTitle: "Chattrix",
      aSubtitle: "Send messages. Get responses.",
      aDescription: "A proficient platform specializing in developing real-time communication systems tailored for Beehive Corporation's diverse web platforms, ensuring seamless message exchange, intelligent responses, and scalable interactions.",
      aDetail: "",
      dTag: "🪐 The Beta Planet (σC:αγG:βS:βP)",
      dSocialLinks: [
        {
          aLinkTitle: "Instagram",
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://chattrix-frontend-v02.netlify.app/"
        },
        {
    ...
    await AdminAboutCompanyModel.create({
      ...
      aDetail: `
Chattrix is the Beta Platform of Anser Enterprise. 
Right now, this platform consists of only one model. That model is:
- Chattrix v01 (α Model)
      `,
      dTag: "truly",
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
    ...
    await AdminAboutCompanyModel.create({
      ...
      aDetail: `
Chattrix is the Beta Planet of Anser Star. 
Till now, this planet consists of only one moon around. That moon is:
- Chattrix v01 (α Moon)
      `,
      dTag: "relatively",
      bCreatedAt: new Date(Date.now()),
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Chattrix Application",
      aDetail: `

### CHATTRIX APPLICATION
...
### THE THREE PILLARS OF CHATTRIX APPLICATION
Chattrix Application is structured around three core applications: 
1. Frontend Application — 
    - The public-facing experience
    - [chattrix-frontend-v02.netlify.app](https://chattrix-frontend-v02.netlify.app)
2. Admin Application — 
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Chattrix Application (Frontend)",
      aSubtitle: "The public-facing experience",
      aDetail: `

### FRONTEND APPLICATION — THE PUBLIC-FACING EXPERIENCE

Chattrix Frontend Application is the user-facing interface developed with ReactJS, providing a seamless, dynamic, and responsive experience. 
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Chattrix Application (Admin)",
      aSubtitle: "Internal control, content, and operations",
      aDetail: `

### ADMIN APPLICATION — INTERNAL CONTROL, CONTENT, AND OPERATIONS

Chattrix Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations. 
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Chattrix Application (Backend)",
...
Chattrix Backend Application is built using NodeJS and ExpressJS, forming the core API layer of the MERN stack system. 
...
3) **Headquarters (Physical Address)**  
   Pune, Maharashtra, India
    ...
    const adminProjectInstance01 = await AdminProjectModel.create({
      ...
      aSubtitle: `Chattrix v01 (α Model)`,
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
      dSocialLinks: [
        {
    ...
    const adminProjectInstance02 = await AdminProjectModel.create({
      aTitle: `Working on it...`,
      aSubtitle: `Chattrix v02 (β Model)`,
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
      dSocialLinks: [
        {
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://chattrix-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://chattrix-backend-v02.onrender.com/"
