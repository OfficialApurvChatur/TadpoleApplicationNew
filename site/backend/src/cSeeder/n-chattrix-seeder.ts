...
- Chattrix v01 (α Moon)
    ...
    await AdminAboutApplicationModel.create({
      ...
      aDetail: `
        ...
        Chattrix Application is a project aims to develop a dynamic landing page application for Chattrix Corporation, mainly using MERN stack, TypeScript and SocketIO. 
        ...
        The application will effectively showcase Chattrix Corporation's identity, projects, and more, enhancing user engagement and administrative efficiency. 
