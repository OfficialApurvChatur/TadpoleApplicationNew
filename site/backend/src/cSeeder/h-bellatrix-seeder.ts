...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/h-bellatrix-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Kirti_Turkar.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/08.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Bellatrix_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Bellatrix_Logo.png", "hero");
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://bellatrix-frontend-v02.netlify.app/"
        },
        {
...
- Blogify Planet (β Planet)
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Bellatrix Application",
      aDetail: `
...
1. Frontend Application — 
    ...
    - [bellatrix-frontend-v02.netlify.app](https://bellatrix-frontend-v02.netlify.app)
2. Admin Application — 
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Bellatrix Application (Frontend)",
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Bellatrix Application (Admin)",
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Bellatrix Application (Backend)",
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://bellatrix-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://bellatrix-backend-v02.onrender.com/"
