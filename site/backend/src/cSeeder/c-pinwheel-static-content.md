...
<details>
  ...
  - **Web Links:**
    ...
    - **Visit Backemd :** [https://pinwheel-backend-v02.onrender.com/](https://pinwheel-backend-v02.onrender.com/)
...
<details>
  ...
  - **Detail :**
    ...
    Right now, this organisation consists of nine applications. These applications are:
    - Beehive Application (α Application)
    - Andromeda Application (β Application)
    - Pinwheel Application (γ Application)
    - Tadpole Application (δ Application)
    - Acrux Application (ε Application)
    - Anser Application (ζ Application)
    - Aquila Application (η Application)
    - Bellatrix Application (θ Application)
    - Capella Application (ι Application)
...
<details>
  ...
  - **Detail :** 
    ...
    Till now, this galaxy consists of nine stars. These stars are:
    - Beehive Star (α Star)
    - Andromeda Star (β Star)
    - Pinwheel Star (γ Star)
    - Tadpole Star (δ Star)
    - Acrux Star (ε Star)
    - Anser Star (ζ Star)
    - Aquila Star (η Star)
    - Bellatrix Star (θ Star)
    - Capella Star (ι Star)
...
<details>
  <summary><strong>Pinwheel Application</strong></summary>

  - **Title :** 
    About Pinwheel Application  
  - **Detail :** 
...
<details>
  <summary><strong>Pinwheel Application (Frontend)</strong></summary>

  - **Title :** 
    About Pinwheel Application (Frontend)  
  - **Subtitle :** 
...
<details>
  <summary><strong>Pinwheel Application (Admin)</strong></summary>

  - **Title :** 
    About Pinwheel Application (Admin)
  - **Subtitle :** 
...
<details>
  <summary><strong>Pinwheel Application (Backend)</strong></summary>

  - **Title :** 
    About Pinwheel Application (Backend)
  - **Subtitle :** 
