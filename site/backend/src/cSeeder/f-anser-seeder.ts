...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/f-anser-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Geeta_Kulkarni.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/06.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Anser_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Anser_Logo.png", "hero");
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://anser-frontend-v02.netlify.app/"
        },
        {
...
Right now, this enterprise consists of two platforms. These platforms are:
- Boilerplate (α Platform)
- Chattrix (β Platform)
      `,
      dTag: "truly",
      bCreatedAt: new Date(Date.now()),
...
- Chattrix (β Planet)
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Anser Application",
      aDetail: `
...
### THE POWER INGREDIENTS OF ANSER APPLICATION 
Anser Application is crafted with these few technologies: 
1. Core Technologies — 
...
### THE THREE PILLARS OF ANSER APPLICATION
Anser Application is structured around three core applications: 
1. Frontend Application — 
    - The public-facing experience
    - [anser-frontend-v02.netlify.app](https://anser-frontend-v02.netlify.app)
2. Admin Application — 
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Anser Application (Frontend)",
      aSubtitle: "The public-facing experience",
      aDetail: `

### FRONTEND APPLICATION — THE PUBLIC-FACING EXPERIENCE

Anser Frontend Application is the user-facing interface developed with ReactJS, providing a seamless, dynamic, and responsive experience. 
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Anser Application (Admin)",
      aSubtitle: "Internal control, content, and operations",
      aDetail: `

### ADMIN APPLICATION — INTERNAL CONTROL, CONTENT, AND OPERATIONS

Anser Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations. 
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Anser Application (Backend)",
...
Anser Backend Application is built using NodeJS and ExpressJS, forming the core API layer of the MERN stack system. 
...
- 🌍 Geo-aware request handling
    ...
    await AdminContactInfoModel.create({
      aTitle: "Contact Us",
      aDetail: `
Anser Contact Information  
The Beta Star can be reached through the following communication channels:

1) **Email (Primary Channel)**  
   soup.anser.enterprise@gmail.com  
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://anser-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://anser-backend-v02.netlify.app/"
