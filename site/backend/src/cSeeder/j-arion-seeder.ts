...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/j-arion-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Rashi_Suryawanshi.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/10.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Arion_Logo.png", "adminhero");
    ...
    const adminHeroSideImage9 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Abol_Logo.png", "adminproject");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Arion_Logo.png", "hero");
    ...
    const heroSideImage9 = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Abol_Logo.png", "project");
    ...
    const adminProjectImage01 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Beehive/5.png", "adminproject");
    const adminProjectImage02 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Andromeda/5.png", "adminproject");
    const adminProjectImage03 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Pinwheel/5.png", "adminproject");
    const adminProjectImage04 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Tadpole/5.png", "adminproject");
    const adminProjectImage05 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Acrux/5.png", "adminproject");
    const adminProjectImage06 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Anser/5.png", "adminproject");
    const adminProjectImage07 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Aquila/5.png", "adminproject");
    const adminProjectImage08 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Bellatrix/5.png", "adminproject");
    const adminProjectImage09 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Capella/5.png", "adminproject");
    const adminProjectImage10 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Arion/5.png", "adminproject");
    const adminProjectImage11 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Ankas/5.png", "adminproject");
    const adminProjectImage12 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Abol/5.png", "adminproject");
    const adminProjectImage13 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Boilerplate/5.png", "adminproject");
    const adminProjectImage14 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Chattrix/5.png", "adminproject");

    const projectImage01 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Beehive/5.png", "project");
    const projectImage02 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Andromeda/5.png", "project");
    const projectImage03 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Pinwheel/5.png", "project");
    const projectImage04 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Tadpole/5.png", "project");
    const projectImage05 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Acrux/5.png", "project");
    const projectImage06 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Anser/5.png", "project");
    const projectImage07 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Aquila/5.png", "project");
    const projectImage08 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Bellatrix/5.png", "project");
    const projectImage09 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Capella/5.png", "project");
    const projectImage10 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Arion/5.png", "project");
    const projectImage11 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Ankas/5.png", "project");
    const projectImage12 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Abol/5.png", "project");
    const projectImage13 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Boilerplate/5.png", "project");
    const projectImage14 = await uploadImage("C:/Users/LENOVO/Downloads/Application_Poster/Chattrix/5.png", "project");
    ...
    await AdminHeroModel.create({
      ...
      aTitle: "Arion",
      aSubtitle: "Empowering Admin Control, Unleashing Efficiency",
      aDescription: "A proficient platform specializing in developing administrative applications tailored for Beehive Corporation's diverse range of web applications, streamlining their management processes effectively.",
      aDetail: "",
      dTag: "🪐 The Alpha Planet (σC:αG:αS:αP)",
      dSocialLinks: [
        {
          aLinkTitle: "Instagram",
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://arion-frontend-v02.netlify.app/"
        },
        {
    ...
    await AdminAboutCompanyModel.create({
      ...
      aDetail: `
Arion is the Alpha Platform of Acrux Enterprise. 
Right now, this platform consists of twenty-two applications. These applications are:
- Beehive Admin (α Application)
- Andromeda Admin (β Application) 
- Pinwheel Admin (γ Application) 
- Tadpole Admin (δ Application) 
- Acrux Admin (ε Application) 
- Anser Admin (ζ Application) 
- Aquila Admin (η Application) 
- Bellatrix Admin (θ Application) 
- Capella Admin (ι Application) 
- Arion Admin (κ Application) 
- Ankas Admin (λ Application) 
- Abol Admin (μ Application) 
- Boilerplate Admin (ν Application) 
- Chattrix Admin (ξ Application) 
- Techfolio Admin (ο Application) 
- Person 01 Admin (π Application) 
- Person 02 Admin (ρ Application) 
- Person 03 Admin (σ Application) 
- Blogify Admin (τ Application) 
- Simad Bhagwatam Admin (υ Application) 
- Bhagwat Gita Admin (φ Application) 
- Interview Question Admin (χ Application) 
      `,
      dTag: "truly",
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
    ...
    await AdminAboutCompanyModel.create({
      ...
      aDetail: `
Arion is the Alpha Planet of Acrux Star. 
Till now, this planet consists of twenty-two moons around. These moons are:
- Beehive Moon (α Moon)
- Andromeda Moon (β Moon) 
- Pinwheel Moon (γ Moon) 
- Tadpole Moon (δ Moon) 
- Acrux Moon (ε Moon) 
- Anser Moon (ζ Moon) 
- Aquila Moon (η Moon) 
- Bellatrix Moon (θ Moon) 
- Capella Moon (ι Moon) 
- Arion Moon (κ Moon) 
- Ankas Moon (λ Moon) 
- Abol Moon (μ Moon)  
- Boilerplate Moon (ν Moon) 
- Chattrix Moon (ξ Moon) 
- Techfolio Moon (ο Moon) 
- Person 01 Moon (π Moon) 
- Person 02 Moon (ρ Moon) 
- Person 03 Moon (σ Moon) 
- Blogify Moon (τ Moon) 
- Simad Bhagwatam Moon (υ Moon) 
- Bhagwat Gita Moon (φ Moon) 
- Interview Question Moon (χ Moon) 
      `,
      dTag: "relatively",
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Arion Application",
      aDetail: `
...
### THE THREE PILLARS OF ARION APPLICATION
Arion Application is structured around three core applications: 
1. Frontend Application — 
    - The public-facing experience
    - [arion-frontend-v02.netlify.app](https://arion-frontend-v02.netlify.app)
2. Admin Application — 
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Arion Application (Frontend)",
      aSubtitle: "The public-facing experience",
      aDetail: `

### FRONTEND APPLICATION — THE PUBLIC-FACING EXPERIENCE

Arion Frontend Application is the user-facing interface developed with ReactJS, providing a seamless, dynamic, and responsive experience. 
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Arion Application (Admin)",
      aSubtitle: "Internal control, content, and operations",
      aDetail: `

### ADMIN APPLICATION — INTERNAL CONTROL, CONTENT, AND OPERATIONS

Arion Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations. 
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Arion Application (Backend)",
...
Arion Backend Application is built using NodeJS and ExpressJS, forming the core API layer of the MERN stack system. 
...
- 🌍 Geo-aware request handling
    ...
    await AdminContactInfoModel.create({
      aTitle: "Contact Us",
      aDetail: `
Arion Contact Information  
The Alpha Planet can be reached through the following communication channels:

1) **Email (Primary Channel)**  
   soup.arion@gmail.com  
...
3) **Headquarters (Physical Address)**  
   Pune, Maharashtra, India
    ...
    console.log("❌ None Admin Branch Group Created");
    ...
    const adminProjectInstance01 = await AdminProjectModel.create({
      ...
      aTitle: `Beehive Application (Admin)`,
      aSubtitle: `${BeehiveConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${BeehiveConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance02 = await AdminProjectModel.create({
      ...
      aTitle: `Andromeda Application (Admin)`,
      aSubtitle: `${AndromedaConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${AndromedaConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance03 = await AdminProjectModel.create({
      ...
      aTitle: `Pinwheel Application (Admin)`,
      aSubtitle: `${PinwheelConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${PinwheelConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance04 = await AdminProjectModel.create({
      ...
      aTitle: `Tadpole Application (Admin)`,
      aSubtitle: `${TadpoleConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${TadpoleConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance05 = await AdminProjectModel.create({
      ...
      aTitle: `Acrux Application (Admin)`,
      aSubtitle: `${AcruxConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${AcruxConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance06 = await AdminProjectModel.create({
      ...
      aTitle: `Anser Application (Admin)`,
      aSubtitle: `${AnserConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${AnserConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance07 = await AdminProjectModel.create({
      ...
      aTitle: `Aquila Application (Admin)`,
      aSubtitle: `${AquilaConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${AquilaConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance08 = await AdminProjectModel.create({
      ...
      aTitle: `Bellatrix Application (Admin)`,
      aSubtitle: `${BellatrixConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${BellatrixConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance09 = await AdminProjectModel.create({
      ...
      aTitle: `Capella Application (Admin)`,
      aSubtitle: `${CapellaConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${CapellaConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance10 = await AdminProjectModel.create({
      ...
      aTitle: `Arion Application (Admin)`,
      aSubtitle: `${ArionConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${ArionConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance11 = await AdminProjectModel.create({
      ...
      aTitle: `Ankas Application (Admin)`,
      aSubtitle: `${AnkasConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${AnkasConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance12 = await AdminProjectModel.create({
      ...
      aTitle: `Abol Application (Admin)`,
      aSubtitle: `${AbolConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${AbolConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance13 = await AdminProjectModel.create({
      ...
      aTitle: `Boilerplate Application (Admin)`,
      aSubtitle: `${BoilerplateConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${BoilerplateConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
    ...
    const adminProjectInstance14 = await AdminProjectModel.create({
      ...
      aTitle: `${ChattrixConst.split("-")[0]} Application (Admin)`,
      aSubtitle: `${ChattrixConst.split("-")[1]}-admin-v02.netlify.app`,
      aDescription: `
${ChattrixConst.split("-")[0]} Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations.
This panel enables administrators to control users, roles, permissions, content, analytics, and operational workflows.
Built with reusable React components, secure routes, and state management (Redux Toolkit / RTK Query), it offers a fast, responsive, and intuitive interface.
The admin panel communicates with the backend through protected API endpoints, ensuring that sensitive operations remain secure and traceable.
      `,
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://arion-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://arion-backend-v02.netlify.app/"
...
3) **Headquarters (Physical Address)**  
   Pune, Maharashtra, India
    ...
    // --- Create Branch Group ---
    console.log("❌ None Branch Group Created");
