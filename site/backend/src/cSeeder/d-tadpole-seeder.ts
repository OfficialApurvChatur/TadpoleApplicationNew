...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/d-tadpole-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Astha_Jain.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/04.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Tadpole_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Tadpole_Logo.png", "hero");
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://tadpole-frontend-v02.netlify.app/"
        },
        {
...
Right now, this organisation consists of three enterprises. These enterprises are:
- Aquila Enterprise (α Enterprise)
- Bellatrix Enterprise (β Enterprise)
- Capella Enterprise (γ Enterprise)
      `,
      dTag: "truly",
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
...
Till now, this galaxy consists of three stars. These stars are:
- Aquila Star (α Star)
- Bellatrix Star (β Star)
- Capella Star (γ Star)
      `,
      dTag: "relatively",
      bCreatedAt: new Date(Date.now()),
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Tadpole Application",
      aDetail: `
...
### THE POWER INGREDIENTS OF TADPOLE APPLICATION 
Tadpole Application is crafted with these few technologies: 
1. Core Technologies — 
...
### THE THREE PILLARS OF TADPOLE APPLICATION
Tadpole Application is structured around three core applications: 
1. Frontend Application — 
    - The public-facing experience
    - [tadpole-frontend-v02.netlify.app](https://tadpole-frontend-v02.netlify.app)
2. Admin Application — 
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Tadpole Application (Frontend)",
      aSubtitle: "The public-facing experience",
      aDetail: `

### FRONTEND APPLICATION — THE PUBLIC-FACING EXPERIENCE

Tadpole Frontend Application is the user-facing interface developed with ReactJS, providing a seamless, dynamic, and responsive experience. 
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Tadpole Application (Admin)",
      aSubtitle: "Internal control, content, and operations",
      aDetail: `

### ADMIN APPLICATION — INTERNAL CONTROL, CONTENT, AND OPERATIONS

Tadpole Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations. 
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Tadpole Application (Backend)",
...
Tadpole Backend Application is built using NodeJS and ExpressJS, forming the core API layer of the MERN stack system. 
...
3) **Headquarters (Physical Address)**  
   Pune, Maharashtra, India
    ...
    const adminProjectGroupInstance04 = await AdminProjectGroupModel.create({
      aTitle: "Aquila Enterprise",
      aSubtitle: "Elevating Success Together",
      aDescription: "A proficient enterprise specializing in developing bespoke web applications for clients with Beehive Corporation.",
      bCreatedAt: new Date(Date.now()),
    ...
    const adminProjectGroupInstance05 = await AdminProjectGroupModel.create({
      aTitle: "Bellatrix Enterprise",
      aSubtitle: "Navigating Beyond Horizon",
      aDescription: "A proficient enterprise specializing in developing bespoke web applications for fostering personal innovation with Beehive Corporation.",
      bCreatedAt: new Date(Date.now()),
    ...
    const adminProjectGroupInstance06 = await AdminProjectGroupModel.create({
      aTitle: "Capella Enterprise",
      aSubtitle: "Innovating Bright Stars",
      aDescription: "A proficient enterprise specializing in developing bespoke web applications for engaging in collaborative projects with Beehive Corporation.",
      bCreatedAt: new Date(Date.now()),
    ...
    await AdminProjectSectionModel.create({
      ...
      bCreatedBy: shraddha._id,
      cProjectGroups: [
        adminProjectGroupInstance04._id,
        adminProjectGroupInstance05._id,
        adminProjectGroupInstance06._id,
      ],
      dSocialLinks: [
        {
          aLinkTitle: "Instagram",
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://tadpole-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://tadpole-backend-v02.netlify.app/"
...
3) **Headquarters (Physical Address)**  
   Pune, Maharashtra, India
    ...
    const projectGroupInstance04 = await ProjectGroupModel.create({
      aTitle: "Aquila Enterprise",
      aSubtitle: "Elevating Success Together",
      aDescription: "A proficient enterprise specializing in developing bespoke web applications for clients with Beehive Corporation.",
      bCreatedAt: new Date(Date.now()),
    ...
    const projectGroupInstance05 = await ProjectGroupModel.create({
      aTitle: "Bellatrix Enterprise",
      aSubtitle: "Navigating Beyond Horizon",
      aDescription: "A proficient enterprise specializing in developing bespoke web applications for fostering personal innovation with Beehive Corporation.",
      bCreatedAt: new Date(Date.now()),
    ...
    const projectGroupInstance06 = await ProjectGroupModel.create({
      aTitle: "Capella Enterprise",
      aSubtitle: "Innovating Bright Stars",
      aDescription: "A proficient enterprise specializing in developing bespoke web applications for engaging in collaborative projects with Beehive Corporation.",
      bCreatedAt: new Date(Date.now()),
    ...
    await ProjectSectionModel.create({
      ...
      bCreatedBy: shraddha._id,
      cProjectGroups: [
        projectGroupInstance04._id,
        projectGroupInstance05._id,
        projectGroupInstance06._id,
      ],
      dSocialLinks: [
        {
          aLinkTitle: "Instagram",
