...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/i-capella-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Priti_Bokade.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/09.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Capella_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Capella_Logo.png", "hero");
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://capella-frontend-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://capella-backend-v02.onrender.com/"
        }
      ],
      dGalleryImages: [
...
Right now, this enterprise has had zero applications till now.
      `,
      dTag: "truly",
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
...
Till now, this star consists of zero planets around, till now.
      `,
      dTag: "relatively",
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Capella Application",
      aDetail: `
...
### THE POWER INGREDIENTS OF CAPELLA APPLICATION 
Capella Application is crafted with these few technologies: 
1. Core Technologies — 
...
### THE THREE PILLARS OF CAPELLA APPLICATION
Capella Application is structured around three core applications: 
1. Frontend Application — 
    - The public-facing experience
    - [capella-frontend-v02.netlify.app](https://capella-frontend-v02.netlify.app)
2. Admin Application — 
    - Internal control, content, and operations
    - [capella-admin-v02.netlify.app](https://capella-admin-v02.netlify.app)
3. Backend Application — 
    - The brain powering logic, data, and communication 
    - [capella-backend-v02.onrender.com](https://capella-backend-v02.onrender.com)
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Capella Application (Frontend)",
      aSubtitle: "The public-facing experience",
      aDetail: `

### FRONTEND APPLICATION — THE PUBLIC-FACING EXPERIENCE

Capella Frontend Application is the user-facing interface developed with ReactJS, providing a seamless, dynamic, and responsive experience. 
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Capella Application (Admin)",
      aSubtitle: "Internal control, content, and operations",
      aDetail: `

### ADMIN APPLICATION — INTERNAL CONTROL, CONTENT, AND OPERATIONS

Capella Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations. 
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Capella Application (Backend)",
...
Capella Backend Application is built using NodeJS and ExpressJS, forming the core API layer of the MERN stack system. 
...
- 🌍 Geo-aware request handling
    ...
    await AdminContactInfoModel.create({
      aTitle: "Contact Us",
      aDetail: `
Capella Contact Information  
The Gamma Star can be reached through the following communication channels:

1) **Email (Primary Channel)**  
   soup.capella.enterprise@gmail.com  
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://capella-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://capella-backend-v02.onrender.com/"
