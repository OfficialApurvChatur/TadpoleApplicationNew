...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/k-ankas-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Rutuja_Bhoyar.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/11.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Ankas_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Ankas_Logo.png", "hero");
    ...
    await AdminHeroModel.create({
      ...
      aTitle: "Ankas",
      aSubtitle: "Fueling Applications With Strong Backend",
      ...
      aDetail: "",
      dTag: "🪐 The Beta Planet (σC:αG:αS:βP)",
      dSocialLinks: [
        {
          aLinkTitle: "Instagram",
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://ankas-frontend-v02.netlify.app/"
        },
        {
    ...
    await AdminAboutCompanyModel.create({
      ...
      aDetail: `
Ankas is the Beta Platform of Acrux Enterprise.  
Right now, this platform consists of twenty-two applications. These applications are:
- Beehive Backend (α Application)
- Andromeda Backend (β Application) 
- Pinwheel Backend (γ Application) 
- Tadpole Backend (δ Application) 
- Acrux Backend (ε Application) 
- Anser Backend (ζ Application) 
- Aquila Backend (η Application) 
- Bellatrix Backend (θ Application) 
- Capella Backend (ι Application) 
- Arion Backend (κ Application) 
- Ankas Backend (λ Application) 
- Abol Backend (μ Application) 
- Boilerplate Backend (ν Application) 
- Chattrix Backend (ξ Application) 
- Techfolio Backend (ο Application) 
- Person 01 Backend (π Application) 
- Person 02 Backend (ρ Application) 
- Person 03 Backend (σ Application) 
- Blogify Backend (τ Application) 
- Simad Bhagwatam Backend (υ Application) 
- Bhagwat Gita Backend (φ Application) 
- Interview Question Backend (χ Application)
      `,
      dTag: "truly",
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
    ...
    await AdminAboutCompanyModel.create({
      ...
      aDetail: `
Ankas is the Beta Planet of Acrux Star. 
...
- Interview Question Moon (χ Moon) 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Ankas Application",
      aDetail: `
...
### THE POWER INGREDIENTS OF ANKAS APPLICATION 
Ankas Application is crafted with these few technologies: 
1. Core Technologies — 
...
### THE THREE PILLARS OF ANKAS APPLICATION
Ankas Application is structured around three core applications: 
1. Frontend Application — 
    - The public-facing experience
    - [ankas-frontend-v02.netlify.app](https://ankas-frontend-v02.netlify.app)
2. Admin Application — 
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Ankas Application (Frontend)",
      aSubtitle: "The public-facing experience",
      aDetail: `

### FRONTEND APPLICATION — THE PUBLIC-FACING EXPERIENCE

Ankas Frontend Application is the user-facing interface developed with ReactJS, providing a seamless, dynamic, and responsive experience. 
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Ankas Application (Admin)",
      aSubtitle: "Internal control, content, and operations",
      aDetail: `

### ADMIN APPLICATION — INTERNAL CONTROL, CONTENT, AND OPERATIONS

Ankas Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations. 
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Ankas Application (Backend)",
...
Ankas Backend Application is built using NodeJS and ExpressJS, forming the core API layer of the MERN stack system. 
...
- 🌍 Geo-aware request handling
    ...
    await AdminContactInfoModel.create({
      aTitle: "Contact Us",
      aDetail: `
Ankas Contact Information  
The Beta Planet can be reached through the following communication channels:

1) **Email (Primary Channel)**  
   soup.ankas@gmail.com  
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://ankas-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://ankas-backend-v02.onrender.com/"
