...
const seeder = async () => {
  try {
    ...
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Beehive_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Beehive_Logo.png", "hero");
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://beehive-frontend-v02.netlify.app/"
        },
        {
...
Right now, this corporation consists of three organisations. These organisations are:
...
Till now, this cluster consists of three galaxies. These galaxies are:
...
3) Tadpole Galaxy (γ Galaxy)
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Beehive Application",
      aDetail: `
...
### THE POWER INGREDIENTS OF BEEHIVE APPLICATION 
Beehive Application is crafted with these few technologies: 
1. Core Technologies — 
...
### THE THREE PILLARS OF BEEHIVE APPLICATION
Beehive Application is structured around three core applications: 
1. Frontend Application — 
    - The public-facing experience
    - [beehive-frontend-v02.netlify.app](https://beehive-frontend-v02.netlify.app)
2. Admin Application — 
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Beehive Application (Frontend)",
      aSubtitle: "The public-facing experience",
      aDetail: `

### FRONTEND APPLICATION — THE PUBLIC-FACING EXPERIENCE

Beehive Frontend Application is the user-facing interface developed with ReactJS, providing a seamless, dynamic, and responsive experience. 
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Beehive Application (Admin)",
      aSubtitle: "Internal control, content, and operations",
      aDetail: `

### ADMIN APPLICATION — INTERNAL CONTROL, CONTENT, AND OPERATIONS

Beehive Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations. 
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Beehive Application (Backend)",
...
Beehive Backend Application is built using NodeJS and ExpressJS, forming the core API layer of the MERN stack system. 
...
The application will effectively showcase Chattrix's identity, projects, and more, enhancing user engagement and administrative efficiency.
    ...
    const adminProjectGroupInstance01 = await AdminProjectGroupModel.create({
      aTitle: "Pinwheel Organisation",
      aSubtitle: "Turning Compassion Into Action",
      aDescription: "A proficient organization specializing in crafting landing web applications tailored for Beehive Corporation, its affiliates, and their enterprises, ensuring optimal digital presence and functionality.",
      bCreatedAt: new Date(Date.now()),
    ...
    await AdminProjectSectionModel.create({
      ...
      bCreatedBy: shraddha._id,
      cProjectGroups: [
        adminProjectGroupInstance01._id,
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://beehive-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://beehive-backend-v02.netlify.app/"
...
The application will effectively showcase Chattrix's identity, projects, and more, enhancing user engagement and administrative efficiency.
    ...
    const projectGroupInstance01 = await ProjectGroupModel.create({
      aTitle: "Pinwheel Organisation",
      aSubtitle: "Turning Compassion Into Action",
      aDescription: "A proficient organization specializing in crafting landing web applications tailored for Beehive Corporation, its affiliates, and their enterprises, ensuring optimal digital presence and functionality.",
      bCreatedAt: new Date(Date.now()),
