...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Kanak_Kshirsagar.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/07.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Aquila_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Aquila_Logo.png", "hero");
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://aquila-frontend-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://aquila-backend-v02.onrender.com/"
        }
      ],
      dGalleryImages: [
...
3. Backend Application — 
    ...
    - [aquila-backend-v02.onrender.com](https://aquila-backend-v02.onrender.com)
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Aquila Application (Frontend)",
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Aquila Application (Admin)",
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Aquila Application (Backend)",
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://aquila-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://aquila-backend-v02.onrender.com/"
