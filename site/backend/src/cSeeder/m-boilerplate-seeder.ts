...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/m-boilerplate-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Sanaa.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/13.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Boilerplate_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Boilerplate_Logo.png", "hero");
    ...
    await AdminHeroModel.create({
      ...
      aTitle: "Boilerplate",
      aSubtitle: "Skip setup. Start building.",
      ...
      aDetail: "",
      dTag: "🪐 The Alpha Planet (σC:αγG:βS:αP)",
      dSocialLinks: [
        {
          aLinkTitle: "Instagram",
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://boilerplate-frontend-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://boilerplate-backend-v02.onrender.com/"
        }
      ],
      dGalleryImages: [
    ...
    await AdminAboutCompanyModel.create({
      ...
      aDetail: `
Boilerplate is the Alpha Platform of Anser Enterprise. 
Right now, this platform consists of only one model. That model is:
- Boilerplate v01 (α Model)
      `,
      dTag: "truly",
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
    ...
    await AdminAboutCompanyModel.create({
      ...
      aDetail: `
Boilerplate is the Alpha Planet of Anser Star. 
Till now, this planet consists of only one moon around. That moon is:
- Boilerplate v01 (α Moon)
      `,
      dTag: "relatively",
      bCreatedAt: new Date(Date.now()),
      bCreatedBy: shraddha._id,
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Boilerplate Application",
      aDetail: `
...
### THE THREE PILLARS OF BOILERPLATE APPLICATION
Boilerplate Application is structured around three core applications: 
1. Frontend Application — 
    - The public-facing experience
    - [boilerplate-frontend-v02.netlify.app](https://boilerplate-frontend-v02.netlify.app)
2. Admin Application — 
    - Internal control, content, and operations
    - [boilerplate-admin-v02.netlify.app](https://boilerplate-admin-v02.netlify.app)
3. Backend Application — 
    - The brain powering logic, data, and communication 
    - [boilerplate-backend-v02.onrender.com](https://boilerplate-backend-v02.onrender.com)
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Boilerplate Application (Frontend)",
      aSubtitle: "The public-facing experience",
      aDetail: `

### FRONTEND APPLICATION — THE PUBLIC-FACING EXPERIENCE

Boilerplate Frontend Application is the user-facing interface developed with ReactJS, providing a seamless, dynamic, and responsive experience. 
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Boilerplate Application (Admin)",
      aSubtitle: "Internal control, content, and operations",
      aDetail: `

### ADMIN APPLICATION — INTERNAL CONTROL, CONTENT, AND OPERATIONS

Boilerplate Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations. 
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Boilerplate Application (Backend)",
...
Boilerplate Backend Application is built using NodeJS and ExpressJS, forming the core API layer of the MERN stack system. 
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://boilerplate-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://boilerplate-backend-v02.onrender.com/"
