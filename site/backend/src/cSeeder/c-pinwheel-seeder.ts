...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/c-pinwheel-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Anisha_Wase.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/03.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Pinwheel_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Pinwheel_Logo.png", "hero");
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://pinwheel-frontend-v02.netlify.app/"
        },
        {
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Pinwheel Application (Frontend)",
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Pinwheel Application (Admin)",
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Pinwheel Application (Backend)",
...
The Beta Galaxy can be reached through the following communication channels:

1) **Email (Primary Channel)**  
   pinwheel.organisation@gmail.com  
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://pinwheel-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://pinwheel-backend-v02.onrender.com/"
