...
const markdownPath = path.join(
  process.cwd(),
  "src/cSeeder/e-acrux-static-content.md"
);
...
const seeder = async () => {
  try {
    ...
    // --- Prepare Image ---
    const shraddhaProfileImage = await uploadImage("C:/Users/LENOVO/Downloads/Avatar/Dhruvika_Khinvasara.png", "user");
    const shraddhaCoverImage = await uploadImage("C:/Users/LENOVO/Downloads/Cover_Images/05.jpg", "user");
    
    const adminHeroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Acrux_Logo.png", "adminhero");
    ...
    const heroLogoImage = await uploadImage("C:/Users/LENOVO/Downloads/No_BG_Logo/Acrux_Logo.png", "hero");
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://acrux-frontend-v02.netlify.app/"
        },
        {
...
Right now, this enterprise consists of three platforms. These platforms are:
- Arion (α Platform)
- Ankas (β Platform)
- Abol (γ Platform)
      `,
...
Till now, this star consists of three planets around. These planets are:
- Arion (α Planet)
- Ankas (β Planet)
- Abol (γ Planet)
      `,
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Acrux Application",
      aDetail: `
...
### THE POWER INGREDIENTS OF ACRUX APPLICATION 
Acrux Application is crafted with these few technologies: 
1. Core Technologies — 
...
### THE THREE PILLARS OF ACRUX APPLICATION
Acrux Application is structured around three core applications: 
1. Frontend Application — 
    - The public-facing experience
    - [acrux-frontend-v02.netlify.app](https://acrux-frontend-v02.netlify.app)
2. Admin Application — 
...
Each app is independently deployable, yet designed to feel like one organism. 
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Acrux Application (Frontend)",
      aSubtitle: "The public-facing experience",
      aDetail: `

### FRONTEND APPLICATION — THE PUBLIC-FACING EXPERIENCE

Acrux Frontend Application is the user-facing interface developed with ReactJS, providing a seamless, dynamic, and responsive experience. 
...
- 📱 Fully responsive, mobile-first design
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Acrux Application (Admin)",
      aSubtitle: "Internal control, content, and operations",
      aDetail: `

### ADMIN APPLICATION — INTERNAL CONTROL, CONTENT, AND OPERATIONS

Acrux Admin Application is a dedicated ReactJS dashboard designed for managing platform-wide data and configurations. 
...
- ⚙️ Configuration-driven layouts
    ...
    await AdminAboutApplicationModel.create({
      aTitle: "About Acrux Application (Backend)",
...
Acrux Backend Application is built using NodeJS and ExpressJS, forming the core API layer of the MERN stack system. 
...
- 🌍 Geo-aware request handling
    ...
    await AdminContactInfoModel.create({
      aTitle: "Contact Us",
      aDetail: `
Acrux Contact Information  
The Alpha Star can be reached through the following communication channels:

1) **Email (Primary Channel)**  
   soup.acrux.enterprise@gmail.com  
      ...
      dWebLinks: [
        {
          ...
          bLinkURL: "https://acrux-admin-v02.netlify.app/"
        },
        {
          aLinkTitle: "Visit Backend",
          bLinkURL: "https://acrux-backend-v02.onrender.com/"
