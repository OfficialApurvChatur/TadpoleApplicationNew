...
export type AccountModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<AccountModelType>({
...
export const AccountModel = mongoose.model<AccountModelType>("AccountModel", schema);
