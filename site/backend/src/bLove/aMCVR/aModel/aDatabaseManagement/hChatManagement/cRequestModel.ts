...
export type RequestModelType = DefaultSchemaUtilityType & {
  // A. BasicInfo Type - Done
  // B. PersonalInfo Type - Done
  // C. RelationInfo Type
  cSender: Types.ObjectId; 
  cReceiver: Types.ObjectId; 
  // D. MoreInfo Type
  // ...
  // E. CriticalInfo Type
  // ..
...
const schema = new mongoose.Schema<RequestModelType>({
...
} as mongoose.SchemaDefinition<RequestModelType> )
...
export const RequestModel = mongoose.model<RequestModelType>("RequestModel", schema);
