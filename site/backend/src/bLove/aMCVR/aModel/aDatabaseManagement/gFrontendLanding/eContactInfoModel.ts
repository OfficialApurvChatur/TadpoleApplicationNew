...
export type ContactInfoModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<ContactInfoModelType>({
...
export const ContactInfoModel = mongoose.model<ContactInfoModelType>("ContactInfoModel", schema);
