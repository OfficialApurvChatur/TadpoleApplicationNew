...
export type CounterModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<CounterModelType>({
...
export const CounterModel = mongoose.model<CounterModelType>("CounterModel", schema);
