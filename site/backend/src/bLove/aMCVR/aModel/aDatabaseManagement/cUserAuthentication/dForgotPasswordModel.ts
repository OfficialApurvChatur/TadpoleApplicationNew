...
export type ForgotPasswordModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<ForgotPasswordModelType>({
...
export const ForgotPasswordModel = mongoose.model<ForgotPasswordModelType>("ForgotPasswordModel", schema);
