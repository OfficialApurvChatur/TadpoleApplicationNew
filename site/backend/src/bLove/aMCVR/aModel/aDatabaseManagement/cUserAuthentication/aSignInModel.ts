...
export type SignInModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<SignInModelType>({
...
export const SignInModel = mongoose.model<SignInModelType>("SignInModel", schema);
