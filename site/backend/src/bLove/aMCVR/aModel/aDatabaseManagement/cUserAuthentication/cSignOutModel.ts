...
export type SignOutModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<SignOutModelType>({
...
export const SignOutModel = mongoose.model<SignOutModelType>("SignOutModel", schema);
