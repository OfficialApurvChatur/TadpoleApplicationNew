...
export type ResetPasswordModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<ResetPasswordModelType>({
...
export const ResetPasswordModel = mongoose.model<ResetPasswordModelType>("ResetPasswordModel", schema);
