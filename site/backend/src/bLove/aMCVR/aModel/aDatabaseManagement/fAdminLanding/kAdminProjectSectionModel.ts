...
export type AdminProjectSectionModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<AdminProjectSectionModelType>({
...
} as mongoose.SchemaDefinition<AdminProjectSectionModelType> )
...
export const AdminProjectSectionModel = mongoose.model<AdminProjectSectionModelType>("AdminProjectSectionModel", schema);
