...
export type AdminCounterModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<AdminCounterModelType>({
...
export const AdminCounterModel = mongoose.model<AdminCounterModelType>("AdminCounterModel", schema);
