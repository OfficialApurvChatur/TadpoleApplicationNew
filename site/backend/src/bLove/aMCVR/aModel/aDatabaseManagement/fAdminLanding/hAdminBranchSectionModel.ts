...
export type AdminBranchSectionModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<AdminBranchSectionModelType>({
...
} as mongoose.SchemaDefinition<AdminBranchSectionModelType> )
...
export const AdminBranchSectionModel = mongoose.model<AdminBranchSectionModelType>("AdminBranchSectionModel", schema);
