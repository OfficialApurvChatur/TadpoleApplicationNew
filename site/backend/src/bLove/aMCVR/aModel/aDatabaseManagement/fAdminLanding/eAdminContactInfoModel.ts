...
export type AdminContactInfoModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<AdminContactInfoModelType>({
...
export const AdminContactInfoModel = mongoose.model<AdminContactInfoModelType>("AdminContactInfoModel", schema);
