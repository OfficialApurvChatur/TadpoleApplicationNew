...
export type AdminProjectGroupModelType = DefaultSchemaUtilityType & {
...
const schema = new mongoose.Schema<AdminProjectGroupModelType>({
...
} as mongoose.SchemaDefinition<AdminProjectGroupModelType> )
...
export const AdminProjectGroupModel = mongoose.model<AdminProjectGroupModelType>("AdminProjectGroupModel", schema);
