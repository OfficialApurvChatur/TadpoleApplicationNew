...
const branchSectionPageController = (Model= "BranchSectionPageModel", Label= "BranchSectionPageModel") => ({
  // Retrieve Controller
  retrieve: catchAsyncMiddleware(
    async (request: express.Request, response: express.Response, next: express.NextFunction) => {
      ...
      cacheCreateMiddleware({ 
        key: cacheVariable.branchSectionPageModel.retrieve({ 
          Label, 
          request 
        }), 
        data: responseData 
...
export default branchSectionPageController;
